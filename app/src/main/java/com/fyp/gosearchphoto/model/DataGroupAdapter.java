...
import com.fyp.gosearchphoto.activity.TabMGroupActivity;
 ...
 */
    ...
    public class DataGroupAdapter extends RecyclerView.Adapter<com.fyp.gosearchphoto.model.DataGroupAdapter.ViewHolder> {

        public static final String ITEM_GROUP_ID = "item_group_id";
        public static final String ITEM_GROUP_NAME = "item_group_name";

        private List<DataGroup> mItems;
        ...
        public DataGroupAdapter(Context context, List<DataGroup> items,  PublicFragment pfragment) {
...
* */
        ...
        @Override
        public com.fyp.gosearchphoto.model.DataGroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            Log.i("preferences", "onCreateViewHolder: ");


            int layoutId = R.layout.list_group;

            LayoutInflater inflater = LayoutInflater.from(mContext);
            View itemView = inflater.inflate(layoutId, parent, false);
            com.fyp.gosearchphoto.model.DataGroupAdapter.ViewHolder viewHolder = new com.fyp.gosearchphoto.model.DataGroupAdapter.ViewHolder(itemView);
            return viewHolder;
        }
        ...
        * */
        @Override
        public void onBindViewHolder(final com.fyp.gosearchphoto.model.DataGroupAdapter.ViewHolder holder, final int position) {
            final DataGroup item = mItems.get(position);


            try {
                holder.tvExistingGroup.setText(item.getGroup_name());
           /* String imageFile = item.getImage();
            ...
            holder.imageView.setImageDrawable(d);*/
                ...
                if(item.getPage_data_type().equals("ManageGroup")){
                    holder.ibGroupAdd.setVisibility(View.GONE);
                }else{
                    holder.ibGroupAdd.setVisibility(View.VISIBLE);
                }
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch(item.getPage_data_type()){
                        ...
                        case "ManageGroup":
                            Intent intent = new Intent(mContext, TabMGroupActivity.class);

                            intent.putExtra(ITEM_GROUP_ID, item.getGroup_id());
                            intent.putExtra(ITEM_GROUP_NAME, item.getGroup_name());
            ...
            holder.ibGroupAdd.setOnClickListener(new View.OnClickListener() {
                int getPos = position;
                @Override
                public void onClick(View v) {
                    Utilities.displayToast(mContext,"Page Name: "+item.getPage_data_type()
                            +"Group Id: "+item.getGroup_id());
            ...
            holder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    Toast.makeText(mContext, "You long clicked " + item.getGroup_name(),
        ...
        * */
        public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public TextView tvExistingGroup;
            public ImageButton ibGroupAdd;
            ...
            public ViewHolder(View itemView) {
                ...
                ibGroupAdd = (ImageButton) itemView.findViewById(R.id.ibGroupAdd);
                tvExistingGroup = (TextView) itemView.findViewById(R.id.tvExistingGroup);

                itemView.setOnClickListener(this);
                ibGroupAdd.setOnClickListener(this);
