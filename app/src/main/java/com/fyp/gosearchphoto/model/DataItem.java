...
import com.fyp.gosearchphoto.database.ItemsTable;
...
public class DataItem implements Parcelable {
    ...
    public DataItem(String itemId, String itemName, String category, String description, int sortPosition, double price, String image) {
        ...
        /**
         *  So essentially I'm saying if I'm creating a new object and
         *  it doesn't have a universal unique ID,
         *  assign it right now and now in the adapter class,
         *  I'll always have a unique ID to pass between activities.
         */
        if (itemId == null) {
